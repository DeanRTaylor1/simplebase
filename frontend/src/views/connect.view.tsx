...
import {ConnectToDB, ListTables, TestConnection} from "wailsjs/go/core/App";
...
function Connect() {
    ...
    const testConnection = () => {
        ...
        TestConnection(config).then((response) => {
    ...
    return (
        <Form {...form}>
            <Button variant={status === null ? "default" : status ? "success" : "error"} onClick={testConnection}>Test Connection</Button>
